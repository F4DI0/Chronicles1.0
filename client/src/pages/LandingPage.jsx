...
function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#2B1D14] to-[#3E2723] text-white flex flex-col items-center">
      {/* Header */}
      <motion.header
        className="w-full flex items-center justify-between px-6 py-4 fixed top-0 bg-[#1E130E] bg-opacity-90 backdrop-blur-md z-50 shadow-lg"
      ...
      >
        ...
        <div className="flex gap-4">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#203A43] text-[#F5E6C8] rounded-md hover:bg-[#2C5364] transition duration-300"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 bg-[#8B5E3C] text-white rounded-md hover:bg-[#A67B5B] transition duration-300"
          >
            <FaUserEdit /> Sign Up
          </button>
        </div>
      ...
      <section className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 px-10 py-12">
        <motion.div
          className="bg-[#3E2723] p-6 rounded-lg shadow-lg text-center hover:shadow-xl transition duration-300"
          whileHover={{ scale: 1.05 }}
        >
          <FaBookOpen className="text-4xl mx-auto text-[#F5E6C8] mb-4" />
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
        >
          <FaUserEdit className="text-4xl mx-auto text-[#F5E6C8] mb-4" />
        ...
        <motion.div
          ...
          whileHover={{ scale: 1.05 }}
        >
          <AiOutlineLogin className="text-4xl mx-auto text-[#F5E6C8] mb-4" />
      ...
      {/* Call to Action */}
      <motion.section
        className="w-full flex flex-col items-center bg-[#2B1D14] p-12 rounded-lg mt-10 text-center shadow-lg"
      ...
      >
        ...
        <div className="flex gap-4 mt-6">
          <button
            type="button"
            onClick={() => navigate("/signup")}
            className="px-6 py-3 bg-[#8B5E3C] text-white rounded-md hover:bg-[#A67B5B] transition duration-300 text-lg"
          >
            Sign Up
          </button>
          <button
            type="button"
            onClick={() => navigate("/login")}
            className="px-6 py-3 bg-[#203A43] text-[#F5E6C8] rounded-md hover:bg-[#2C5364] transition duration-300 text-lg"
          >
            Login
          </button>
        </div>
      ...
      {/* Footer */}
      <footer className="w-full text-center py-6 mt-10 text-[#E4C9A8] bg-[#1E130E]">
